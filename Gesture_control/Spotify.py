# wrapper file for spotify API
# endpoints used are: player, previous, next, pause, play, volume up, volume down, save, remove
...
from Gesture_control.constants import SCOPE
...
class SpotifyAPI(QThread):
    ...
    # skip to previous track endpoint
    ...
    # save/remove track from saved songs endpoint
    ...
    # connect detected gestures to actions
